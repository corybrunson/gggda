...
Some new statistical transformations provide new ways of analyzing bivariate data, for example the bag-and-bolster plot (paired with a dedicated composite geom):
