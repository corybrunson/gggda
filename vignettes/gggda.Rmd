...
This has the effect of positioning Judge Driscoll similarly to Judge Saden, despite Saden's superior rating on every other criterion.[^quality]
...
The larger {ggplot2} extension family provides sevenal additional tools for multivariate data visualization to both facilitate and complicate your efforts.
